...
Risk level criteria:
- "high": infrastructure files (Dockerfile, CI configs, pyproject.toml),
  security-sensitive code, or changes with broad blast radius
- "medium": any source-code modification (default for code-generation tasks)
- "low": documentation-only changes, comment updates, or trivial renames
