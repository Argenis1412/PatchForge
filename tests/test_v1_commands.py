...
""",
    ...
    with (
        ...
        patch("orchestrator.validation_workspace.run_validation_in_copy", return_value=mock_val_out),
        ...
        current_head_res = subprocess.run(
            ["git", "rev-parse", "HEAD"], cwd=target_repo, check=True, capture_output=True, text=True
        )
